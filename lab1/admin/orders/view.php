                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span
                                            class="order-status bg-<?php echo $status_classes[$order['status']] ?? 'secondary'; ?>">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Ngày đặt:</strong>
                                                <?php echo isset($order['order_date']) ? date('d/m/Y H:i', strtotime($order['order_date'])) : 'N/A'; ?>
                                            </p>
                                            <p><strong>Cập nhật lần cuối:</strong>
                                                <?php echo isset($order['updated_at']) ? date('d/m/Y H:i', strtotime($order['updated_at'])) : 'N/A'; ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Phương thức thanh toán:</strong>
                                                <?php echo $order['payment_method'] ?? 'N/A'; ?></p>
                                            <p><strong>Trạng thái thanh toán:</strong>
                                                <?php echo $order['payment_status'] ?? 'Chưa thanh toán'; ?></p>
                                        </div>
                                    </div>
                                    ...
                                    <form method="POST" class="mt-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="status">
                                                ...
                                                <option value="<?php echo $value; ?>"
                                                    <?php echo ($value == $order['status']) ? 'selected' : ''; ?>>
                                                    <?php echo $label; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="status_note" name="status_note"
                                                rows="2"><?php echo htmlspecialchars($order['status_note'] ?? ''); ?></textarea>
                                        </div>
                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <?php else: ?>
                                                        <div
                                                            class="product-img mr-2 bg-light d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small
                                                                class="text-muted"><?php echo $item['options']; ?></small>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <strong><?php echo number_format($order['total_amount'], 0, ',', '.'); ?>
                                                        VNĐ</strong>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p><?php echo nl2br(htmlspecialchars($order['shipping_address'] ?? 'Không có thông tin')); ?>
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                <div class="d-flex justify-content-between">
                                                    <h6 class="mb-1">
                                                        <span
                                                            class="badge badge-<?php echo $status_class; ?> status-badge">
                                                ...
                                                <p class="mb-0 mt-2 small">
                                                    <?php echo nl2br(htmlspecialchars($history['note'])); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php endforeach; ?>
