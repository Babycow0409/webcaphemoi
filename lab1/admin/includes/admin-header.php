...
<head>
    ...
    <link rel="stylesheet" href="<?php echo str_repeat("../", substr_count($_SERVER['PHP_SELF'], "/", 1) - 2); ?>admin/includes/admin-style.css">
</head>
<body>
        ...
        <div class="row">
            ...
            <div class="sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo str_repeat("../", substr_count($_SERVER['PHP_SELF'], "/", 1) - 2); ?>admin/logout.php">
            ...
            <div class="content">
                <div class="header">
                    <h2><i class="fas fa-<?php echo isset($header_icon) ? $header_icon : 'tachometer-alt'; ?> mr-2"></i> <?php echo isset($page_title) ? $page_title : 'Tổng quan'; ?></h2>
                    <div>
